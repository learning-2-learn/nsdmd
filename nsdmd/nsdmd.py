...
class NSDMD:
    ...
    def fit_reduction(self, x, t_len, sr):
        ...
        idxs, self.errors_, self.num_modes_ = feature_selector(
            soln,
            x,
            self.feature_N,
            ...
            for j, r in enumerate(np.array(idx_excluded)):
                ...
                if f_method == "grad":
                    ...
                    f_hat = exact_f_from_Bf(
                        B_sub, f_sub, N, var_thresh=exact_var_thresh
                    )
